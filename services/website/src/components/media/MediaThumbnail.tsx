...
export const MediaThumbnail = (props: MediaThumbnailProps) => {
  const { data, isPreviewOpen, onTogglePreview } = props;
  ...
  return (
    <div style={{ height: "200px", maxWidth: "350px" }}>
      <div className="mt-3">
        {" "}
...
export const ImageThumbnail = ({
  ...
  return (
    <div style={{ height: "200px", maxWidth: "350px", position: "relative" }}>
      <div className="mt-3" onClick={onTogglePreview}>
        <img src={data.url} style={{ maxHeight: "200px" }} />
      </div>
      <div>
        <Modal
        ...
        >
          ...
          >
            <img src={data.url} style={{ maxHeight: "100%", margin: "auto" }} />
          </ModalBody>
        </Modal>
      </div>
    </div>
